function fn() {
    ...
    config.projetCollaborateurUrl = config.adminUri + 'projetCollaborateur/';
    config.domaineInterventionCollaborateurUrl = config.adminUri + 'domaineInterventionCollaborateur/';
    config.projetUrl = config.adminUri + 'projet/';
    config.achatUrl = config.adminUri + 'achat/';
    config.categorieArticleUrl = config.adminUri + 'categorieArticle/';
    config.articleUrl = config.adminUri + 'article/';
    config.factureUrl = config.adminUri + 'facture/';
    config.projetArticleUrl = config.adminUri + 'projetArticle/';
    config.typeFactureUrl = config.adminUri + 'typeFacture/';
    config.domaineInterventionUrl = config.adminUri + 'domaineIntervention/';
    config.pieceUrl = config.adminUri + 'piece/';
    config.collaborateurUrl = config.adminUri + 'collaborateur/';
    config.etatArticleUrl = config.adminUri + 'etatArticle/';
    config.achatDetailUrl = config.adminUri + 'achatDetail/';
