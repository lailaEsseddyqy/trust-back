    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/responsableachat/login").permitAll()
                                .requestMatchers("/api/chefprojet/login").permitAll()
                                .requestMatchers("/api/comptable/login").permitAll()
                                .requestMatchers("/api/admin/login").permitAll()
                                .requestMatchers("/api/responsableachat/**").hasAnyAuthority(AuthoritiesConstants.RESPONSABLEACHAT)
                                .requestMatchers("/api/chefprojet/**").hasAnyAuthority(AuthoritiesConstants.CHEFPROJET)
                                .requestMatchers("/api/comptable/**").hasAnyAuthority(AuthoritiesConstants.COMPTABLE)
