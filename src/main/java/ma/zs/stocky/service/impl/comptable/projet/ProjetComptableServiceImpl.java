...
import ma.zs.stocky.service.facade.comptable.projet.PieceComptableService ;
...
import ma.zs.stocky.service.facade.comptable.commun.ClientComptableService ;
import ma.zs.stocky.bean.core.commun.Client ;

import java.util.List;
@Service
public class ProjetComptableServiceImpl implements ProjetComptableService {
    ...
    @Autowired
    private ProjetArticleComptableService projetArticleService ;
    @Autowired
    private PieceComptableService pieceService ;
    @Autowired
    private ProjetCollaborateurComptableService projetCollaborateurService ;
    @Autowired
    private EtatAvancementComptableService etatAvancementService ;
    @Autowired
    private ClientComptableService clientService ;
