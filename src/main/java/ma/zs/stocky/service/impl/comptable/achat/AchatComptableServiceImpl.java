...
import ma.zs.stocky.service.facade.comptable.achat.EtatAchatComptableService ;
import ma.zs.stocky.bean.core.achat.EtatAchat ;

import java.util.List;
@Service
public class AchatComptableServiceImpl implements AchatComptableService {
    ...
    @Autowired
    private AchatDetailComptableService achatDetailService ;
    @Autowired
    private FournisseurComptableService fournisseurService ;
    @Autowired
    private FactureComptableService factureService ;
    @Autowired
    private EtatAchatComptableService etatAchatService ;
