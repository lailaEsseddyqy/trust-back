...
import java.util.List;
@Service
public class CollaborateurComptableServiceImpl implements CollaborateurComptableService {
    ...
    @Autowired
    private DomaineInterventionCollaborateurComptableService domaineInterventionCollaborateurService ;
