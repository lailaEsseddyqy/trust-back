package ma.zs.stocky.service.impl.comptable.article;
...
import ma.zs.stocky.service.facade.comptable.article.EtatArticleComptableService ;
import ma.zs.stocky.bean.core.article.EtatArticle ;
import ma.zs.stocky.service.facade.comptable.commun.FournisseurComptableService ;
import ma.zs.stocky.bean.core.commun.Fournisseur ;
import ma.zs.stocky.service.facade.comptable.article.MarqueComptableService ;
import ma.zs.stocky.bean.core.article.Marque ;
import ma.zs.stocky.service.facade.comptable.article.CategorieArticleComptableService ;
import ma.zs.stocky.bean.core.article.CategorieArticle ;

import java.util.List;
@Service
public class ArticleComptableServiceImpl implements ArticleComptableService {
    ...
    @Autowired
    private EtatArticleComptableService etatArticleService ;
    @Autowired
    private FournisseurComptableService fournisseurService ;
    @Autowired
    private MarqueComptableService marqueService ;
    @Autowired
    private CategorieArticleComptableService categorieArticleService ;
