...
import ma.zs.stocky.service.facade.chefprojet.article.EtatArticleChefprojetService ;
import ma.zs.stocky.bean.core.article.EtatArticle ;
import ma.zs.stocky.service.facade.chefprojet.commun.FournisseurChefprojetService ;
...
import ma.zs.stocky.service.facade.chefprojet.article.CategorieArticleChefprojetService ;
import ma.zs.stocky.bean.core.article.CategorieArticle ;

import java.util.List;
@Service
public class ArticleChefprojetServiceImpl implements ArticleChefprojetService {
    ...
    @Autowired
    private EtatArticleChefprojetService etatArticleService ;
    @Autowired
    private FournisseurChefprojetService fournisseurService ;
    @Autowired
    private MarqueChefprojetService marqueService ;
    @Autowired
    private CategorieArticleChefprojetService categorieArticleService ;
