...
import java.util.List;
@Service
public class FactureResponsableachatServiceImpl implements FactureResponsableachatService {
    ...
    @Autowired
    private TypeFactureResponsableachatService typeFactureService ;
