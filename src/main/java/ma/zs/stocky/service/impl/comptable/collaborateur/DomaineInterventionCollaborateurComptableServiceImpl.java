...
import ma.zs.stocky.service.facade.comptable.collaborateur.DomaineInterventionCollaborateurComptableService;
...
import java.util.List;
@Service
public class DomaineInterventionCollaborateurComptableServiceImpl implements DomaineInterventionCollaborateurComptableService {
    ...
    @Autowired
    private DomaineInterventionComptableService domaineInterventionService ;
    @Autowired
