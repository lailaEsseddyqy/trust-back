...
import java.util.List;
@Service
public class AchatDetailChefprojetServiceImpl implements AchatDetailChefprojetService {
    ...
    @Autowired
    private ArticleChefprojetService articleService ;
    @Autowired
    private AchatChefprojetService achatService ;
