...
import ma.zs.stocky.service.facade.admin.achat.AchatDetailAdminService ;
...
import ma.zs.stocky.service.facade.admin.achat.EtatAchatAdminService ;
import ma.zs.stocky.bean.core.achat.EtatAchat ;

import java.util.List;
@Service
public class AchatAdminServiceImpl implements AchatAdminService {
    ...
    @Autowired
    private AchatDetailAdminService achatDetailService ;
    @Autowired
