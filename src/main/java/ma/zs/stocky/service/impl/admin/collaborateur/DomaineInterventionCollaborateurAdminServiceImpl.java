...
import java.util.List;
@Service
public class DomaineInterventionCollaborateurAdminServiceImpl implements DomaineInterventionCollaborateurAdminService {
    ...
    @Autowired
    private DomaineInterventionAdminService domaineInterventionService ;
    @Autowired
