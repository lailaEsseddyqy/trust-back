...
import ma.zs.stocky.service.facade.responsableachat.collaborateur.DomaineInterventionCollaborateurResponsableachatService;
...
import java.util.List;
@Service
public class DomaineInterventionCollaborateurResponsableachatServiceImpl implements DomaineInterventionCollaborateurResponsableachatService {
    ...
    @Autowired
    private DomaineInterventionResponsableachatService domaineInterventionService ;
    @Autowired
    private CollaborateurResponsableachatService collaborateurService ;
