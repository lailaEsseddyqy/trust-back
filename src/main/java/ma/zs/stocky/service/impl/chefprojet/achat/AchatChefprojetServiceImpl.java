...
import ma.zs.stocky.service.facade.chefprojet.achat.AchatDetailChefprojetService ;
...
import ma.zs.stocky.service.facade.chefprojet.achat.EtatAchatChefprojetService ;
import ma.zs.stocky.bean.core.achat.EtatAchat ;

import java.util.List;
@Service
public class AchatChefprojetServiceImpl implements AchatChefprojetService {
    ...
    @Autowired
    private AchatDetailChefprojetService achatDetailService ;
    @Autowired
    private FournisseurChefprojetService fournisseurService ;
    @Autowired
    private FactureChefprojetService factureService ;
    @Autowired
    private EtatAchatChefprojetService etatAchatService ;
