...
import java.util.List;
@Service
public class CollaborateurChefprojetServiceImpl implements CollaborateurChefprojetService {
    ...
    @Autowired
    private DomaineInterventionCollaborateurChefprojetService domaineInterventionCollaborateurService ;
