...
import java.util.List;
@Service
public class ProjetArticleResponsableachatServiceImpl implements ProjetArticleResponsableachatService {
    ...
    @Autowired
    private ArticleResponsableachatService articleService ;
    @Autowired
    private ProjetResponsableachatService projetService ;
