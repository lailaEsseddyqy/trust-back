...
import ma.zs.stocky.service.facade.admin.projet.ProjetArticleAdminService ;
import ma.zs.stocky.bean.core.projet.ProjetArticle ;
import ma.zs.stocky.service.facade.admin.projet.PieceAdminService ;
import ma.zs.stocky.service.facade.admin.projet.ProjetCollaborateurAdminService ;
import ma.zs.stocky.bean.core.projet.ProjetCollaborateur ;
import ma.zs.stocky.service.facade.admin.projet.EtatAvancementAdminService ;
...
public class ProjetAdminServiceImpl implements ProjetAdminService {
    ...
    @Autowired
    private ProjetArticleAdminService projetArticleService ;
    @Autowired
    private PieceAdminService pieceService ;
    @Autowired
    private ProjetCollaborateurAdminService projetCollaborateurService ;
    @Autowired
