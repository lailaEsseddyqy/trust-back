...
import java.util.List;
@Service
public class CollaborateurResponsableachatServiceImpl implements CollaborateurResponsableachatService {
    ...
    @Autowired
    private DomaineInterventionCollaborateurResponsableachatService domaineInterventionCollaborateurService ;
