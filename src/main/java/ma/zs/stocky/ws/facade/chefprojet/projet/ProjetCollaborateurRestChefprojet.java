...
@RestController
@RequestMapping("/api/chefprojet/projetCollaborateur/")
public class ProjetCollaborateurRestChefprojet {
    ...
    @Autowired private ProjetCollaborateurChefprojetService service;
