...
@RestController
@RequestMapping("/api/responsableachat/projetArticle/")
public class ProjetArticleRestResponsableachat {
    ...
    @Autowired private ProjetArticleResponsableachatService service;
