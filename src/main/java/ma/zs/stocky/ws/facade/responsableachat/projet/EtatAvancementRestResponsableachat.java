...
@RestController
@RequestMapping("/api/responsableachat/etatAvancement/")
public class EtatAvancementRestResponsableachat {
    ...
    @Operation(summary = "Finds a etatAvancement by libelle")
    @GetMapping("libelle/{libelle}")
    public ResponseEntity<EtatAvancementDto> findByLibelle(@PathVariable String libelle) {
	    EtatAvancement t = service.findByReferenceEntity(new EtatAvancement(libelle));
        if (t != null) {
            EtatAvancementDto dto = converter.toDto(t);
            return getDtoResponseEntity(dto);
        }
    ...
    @Autowired private EtatAvancementResponsableachatService service;
