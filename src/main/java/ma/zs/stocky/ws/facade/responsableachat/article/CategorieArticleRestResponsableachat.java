package  ma.zs.stocky.ws.facade.responsableachat.article;
...
@RestController
@RequestMapping("/api/responsableachat/categorieArticle/")
public class CategorieArticleRestResponsableachat {
    ...
    @Autowired private CategorieArticleResponsableachatService service;
