...
@RestController
@RequestMapping("/api/responsableachat/domaineIntervention/")
public class DomaineInterventionRestResponsableachat {
    ...
    @Autowired private DomaineInterventionResponsableachatService service;
