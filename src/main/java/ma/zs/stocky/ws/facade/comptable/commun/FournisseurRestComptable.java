package  ma.zs.stocky.ws.facade.comptable.commun;
...
@RestController
@RequestMapping("/api/comptable/fournisseur/")
public class FournisseurRestComptable {
    ...
    @Autowired private FournisseurComptableService service;
