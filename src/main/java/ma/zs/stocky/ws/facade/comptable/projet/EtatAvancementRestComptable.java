package  ma.zs.stocky.ws.facade.comptable.projet;
...
@RestController
@RequestMapping("/api/comptable/etatAvancement/")
public class EtatAvancementRestComptable {
    ...
    @Autowired private EtatAvancementComptableService service;
