...
@RestController
@RequestMapping("/api/comptable/domaineInterventionCollaborateur/")
public class DomaineInterventionCollaborateurRestComptable {
    ...
    @Autowired private DomaineInterventionCollaborateurComptableService service;
