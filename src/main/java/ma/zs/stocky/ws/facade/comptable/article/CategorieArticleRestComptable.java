package  ma.zs.stocky.ws.facade.comptable.article;
...
@RestController
@RequestMapping("/api/comptable/categorieArticle/")
public class CategorieArticleRestComptable {
    ...
    @Autowired private CategorieArticleComptableService service;
