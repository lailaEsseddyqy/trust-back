...
@RestController
@RequestMapping("/api/chefprojet/domaineIntervention/")
public class DomaineInterventionRestChefprojet {
    ...
    @Autowired private DomaineInterventionChefprojetService service;
