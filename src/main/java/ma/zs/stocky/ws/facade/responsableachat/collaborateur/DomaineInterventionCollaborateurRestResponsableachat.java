...
@RestController
@RequestMapping("/api/responsableachat/domaineInterventionCollaborateur/")
public class DomaineInterventionCollaborateurRestResponsableachat {
    ...
    @Autowired private DomaineInterventionCollaborateurResponsableachatService service;
