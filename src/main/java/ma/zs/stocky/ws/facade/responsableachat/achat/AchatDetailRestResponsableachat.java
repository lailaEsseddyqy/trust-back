...
@RestController
@RequestMapping("/api/responsableachat/achatDetail/")
public class AchatDetailRestResponsableachat {
    ...
    @Autowired private AchatDetailResponsableachatService service;
