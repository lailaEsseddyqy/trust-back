...
@RestController
@RequestMapping("/api/comptable/projetCollaborateur/")
public class ProjetCollaborateurRestComptable {
    ...
    @Autowired private ProjetCollaborateurComptableService service;
