package  ma.zs.stocky.ws.facade.chefprojet.collaborateur;
...
@RestController
@RequestMapping("/api/chefprojet/domaineInterventionCollaborateur/")
public class DomaineInterventionCollaborateurRestChefprojet {
    ...
    @Autowired private DomaineInterventionCollaborateurChefprojetService service;
