...
@RestController
@RequestMapping("/api/responsableachat/etatArticle/")
public class EtatArticleRestResponsableachat {
    ...
    @Autowired private EtatArticleResponsableachatService service;
