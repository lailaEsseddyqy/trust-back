...
@RestController
@RequestMapping("/api/responsableachat/typeFacture/")
public class TypeFactureRestResponsableachat {
    ...
    @Autowired private TypeFactureResponsableachatService service;
